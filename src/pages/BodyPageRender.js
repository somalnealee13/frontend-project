...
const RenderBodypage = async () => {
  ...
  bodyContent.innerHTML = `
    <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 decoration-sky-600 ">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center justify-start rtl:justify-end">
                    ...
                    <a href="https://flowbite.com" class="flex ms-2 md:me-24">
                        <img src="10dfcdb8-4269-4f95-b82b-24f822d1e651.jpeg" class="h-8 me-3" alt="FlowBite Logo" />
    ...
    <div class="relative w-full max-w-md max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
                <img class="profileModal" src="${
                  import.meta.env.VITE_API_IMG
                }/${result.image}" alt="user photo" >
                <p class="text-gray-900 dark:text-white">${result.nombre} ${
    result.apellido
  }</p>
